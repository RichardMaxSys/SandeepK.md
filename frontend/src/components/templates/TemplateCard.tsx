...
/**
 * TemplateCard
 * Shows a real rendered PNG thumbnail (generated by scripts/generate-thumbnails.js).
 * Falls back to the CSS <TemplatePreview> component if the image fails to load.
 *
 * Thumbnails live at: /thumbnails/{slug}.png  (public/thumbnails/)
 */
  ...
  return (
    ...
    >
      ...
      >
        {!imgFailed ? (
          <img
            src={`/thumbnails/${template.slug}.png`}
          ...
          // CSS fallback (only mounts if the image fails)
